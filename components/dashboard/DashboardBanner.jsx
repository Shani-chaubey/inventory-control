...
const DashboardBanner = () => {
    ...
    return (
        <div className={`relative grid items-center grid-cols-12 gap-4 px-16 py-6 bg-white ${hidden ? "hidden" : ""}`}>
            {/* Icon  */}
            ...
            <div className='items-center col-span-4'>
                <button className='px-4 py-1 text-white uppercase text-sm bg-blue-500 rounded-lg'>Enable</button>
            </div>
